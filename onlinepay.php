...
<html>
  ...
  <head>
    <title> PEMBAYARAN ONLINE | YUMMY SNACKS </title>
  </head>
...
<div class="container">
    <div class="row">
        <div class="jumbotron">
          <h1 class="text-center">Pembayaran Online</h1>
          <p class="text-center">Masukan Rincian Pembayaran di Bawah Ini.</p>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <h5 class="text-muted"> Nomor Kartu Kredit</h5>
                            </div>
