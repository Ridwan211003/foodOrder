...
<html>
  ...
  <head>
    <title> KERANJANG | YUMMY SNACKS</title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-shopping-cart"></span> Keranjang
             (<?php
...
if(!empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        ...
        <p>Keranjang belanja anda sudah terisi. Periksa kembali pesanan anda. Selamat Menikmati !!!</p>
...
<td><a href="cart.php?action=delete&id=<?php echo $values["food_id"]; ?>"><span class="text-danger">Hapus</span></a></td>
</tr>
<?php 
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1>Keranjang Belanja</h1>
        <p>Keranjang belanja anda masih kosong. Silahkan kembali ke menu dan <a href="foodlist.php">Pesan Sekarang.</a></p>
