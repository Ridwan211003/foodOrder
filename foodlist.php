...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Daftar Menu </a></li>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
      <img src="images/BANNERTB.png" style="width:100%;">
      <div class="carousel-caption">
      </div>
      </div>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Selamat Datang di YUMMY SNACKS</h1>      
...
<h5 class="text-info"><b>Komposisi: </b><?php echo $row["description"]; ?></h5>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Menu Sedang Tidak Tersedia</h1> </label>
        <p>Masih Ingin Pesan?</p>
      </center>
