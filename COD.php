...
?>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Pesanan Telah Berhasil.</h1>
          </div>
        </div>
        <br>

<h2 class="text-center"> Terima Kasih Sudah Order di YUMMY SNACKS!.</h2>
...
<h3 class="text-center"> <strong>Nomor Pesanan Kamu:</strong> <span style="color: blue;"><?php echo "$number"; ?></span> </h3>
