...
<html>
  ...
  <head>
    <title> KONTAK KAMI | YUMMMY SNACKS  </title>
  </head>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="contactus.php">Kontak Kami</a></li>
          </ul>
...
?>
    ...
    <div class="heading">
     <strong>Ingin Menghubungi <span class="edit"> YUMMMY SNACKS </span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Form Kontak</h3>
          ...
          <div class="form-group">
           ...
           <span class="help-block"><p id="characterLeft" class="help-block">Panjang Maksimal 140 Karakter </p></span>
          </div> 
